...
\author{Dr. Gregory Kapfhammer}

\section{Introduction}
Size and complexity of modern Python programs:
\begin{itemize}
\item lack of types
\end{itemize}
Possible misleading nature of statement coverage:
\begin{itemize}
\item only what was executed
\item doesn't factor in branches and iteration
\item no information on data state
\item quality of the oracle
\end{itemize}
