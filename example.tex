...
%\renewcommand{\columnbackgroundcolor}{black} Font of side columns
%\renewcommand{\columnfontcolor}{gray} Background of main column
%\renewcommand{\maincolumnbackgroundcolor}{empirical}
%\renewcommand{\maincolumnbackgroundcolor}{theory}
%\renewcommand{\maincolumnbackgroundcolor}{methods}
%\renewcommand{\maincolumnbackgroundcolor}{intervention} Font of main column
...
\betterposter{
  ...
  Methods using Python and Pytest} \author{Nicholas Tocci} \author{Gregory
Kapfhammer}
  ...
  %
  Although useful, test coverage does not suitably signal adequacy.
  %
  ...
  psuedo-tested methods, Function-Fiasco can discover them automatically.

  \section{Implementation}

  \centering\nointerlineskip \include{flow}
